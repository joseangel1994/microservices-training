...
/**
 * @author Jose Exposito
 */

@Tag(
        name = "CRUD REST APIs for Cards in Demo",
        description = "CRUD REST APIs in Demo to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside Demo"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
